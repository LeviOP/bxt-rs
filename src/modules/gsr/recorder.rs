...
impl Recorder {
    ...
    pub unsafe fn record_frame(&mut self, marker: MainThreadMarker) -> eyre::Result<()> {
        ...
        // if let Some(last_viewmodel_index) = self.last_viewmodel {
        //     let last_viewmodel_entity = &mut self.entities[last_viewmodel_index];
        //
        //     if viewent.model == last_viewmodel_entity.model {
        //         last_viewmodel_entity.seen = true;
        //         let changes = last_viewmodel_entity.get_changes_and_update(viewent);
        //
        //         if !changes.is_empty() {
        //             messages.push(Message::UpdateObject(
        //                 Object::Entity(*last_viewmodel_entity),
        //                 changes,
        //             ));
        //         }
        //
        ...
        // }
        //
        //     if viewent.model.is_null() {
        //         self.last_viewmodel = None;
        //         break 'update_viewent;
        //     }
        //
        //     if let Some(&existing_index) = self.viewmodel_entities.get(&viewent.model) {
        //         let entity = &mut self.entities[existing_index];
        //
        //         let mut changes = entity.get_changes_and_update(viewent);
        //         entity.draw = true;
        //         entity.seen = true;
        //
        //         changes.push(ObjectField::Draw(true));
        ...
        //         ));
        //
        //         self.last_viewmodel = Some(existing_index);
        //     } else {
        //         let index = self.entities.len();
        //         let model_index = *self
        //             .model_index_map
        //             .get(&(viewent.model as *const model_s))
        //             .expect("viewent model pointer missing from model list");
        //
        //         let new_entity = Entity::new(viewent, index as u32, model_index, None);
        //
        //         messages.push(Message::NewObject(Object::Entity(new_entity), 1));
        //
        //         self.entities.push(new_entity);
        //         self.viewmodel_entities.insert(viewent.model, index);
        //         self.last_viewmodel = Some(index);
        //     }
        // }
